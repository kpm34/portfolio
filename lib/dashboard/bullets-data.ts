...
export const summaryTemplates: Record<string, string> = {
  'ai-solutions-engineer': 'Software engineer specializing in AI-powered solutions — LLM integration, RAG pipelines, multi-agent systems, and production ML deployments. Built dual AI systems (Claude + Gemini), vector search pipelines with Pinecone, and multi-agent architectures with consensus-based decision making. M.S. in Human Physiology with a quantitative research background.',
  'fullstack-developer': 'Full-stack software engineer building production SaaS applications with Next.js, TypeScript, PostgreSQL, and real-time systems. Ships end-to-end: database design with RLS, WebSocket draft rooms, Stripe billing, OAuth authentication, and 3D graphics. Delivered 100+ features as a solo developer in 4 months. M.S. in Human Physiology.',
  'data-scientist': 'Software engineer with strong data science capabilities — ML prediction engines (XGBoost + Ridge Regression), statistical analysis (Monte Carlo, Pearson correlation, covariance matrices), and production data pipelines. Built backtesting engines, financial modeling tools, and analytics dashboards. M.S. in Human Physiology (3.93 GPA) with quantitative research background.',
  'ml-engineer': 'Software engineer building production ML systems — prediction engines, ETL pipelines, model backtesting, and cloud deployment. Built XGBoost + Ridge Regression ensembles with automated weekly backtesting, Docker-containerized ML microservices, and 16-cron-job automation infrastructure. M.S. in Human Physiology with quantitative research training.',
  'data-analyst': 'Software engineer with deep data analysis skills — PostgreSQL (50+ tables, 30+ stored procedures), statistical analysis (Pearson correlation, Monte Carlo, quartile decomposition), and data visualization (Recharts dashboards, analytics funnels). Built financial backtesting engines and admin dashboards with pattern grading systems. M.S. in Human Physiology (3.93 GPA).',
};
